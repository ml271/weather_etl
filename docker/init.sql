...
CREATE TABLE IF NOT EXISTS weather_hourly (
    ...
    weather_code        INTEGER,          -- WMO code
    is_day              BOOLEAN,
    soil_temperature_0cm  DECIMAL(5, 2),  -- °C  surface (0 cm)
    soil_temperature_6cm  DECIMAL(5, 2),  -- °C  shallow (6 cm)
    soil_temperature_18cm DECIMAL(5, 2),  -- °C  mid (18 cm)
    soil_moisture_0_1cm   DECIMAL(8, 6),  -- m³/m³  0–1 cm
    soil_moisture_1_3cm   DECIMAL(8, 6),  -- m³/m³  1–3 cm
    soil_moisture_3_9cm   DECIMAL(8, 6),  -- m³/m³  3–9 cm
    created_at          TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
...
-- Warning templates (predefined / quick-start)
...
-- Warning notifications (prevents duplicate emails per warning × forecast_date)
...
CREATE INDEX IF NOT EXISTS idx_warning_notifications_warning_id
    ON warning_notifications(warning_id);
